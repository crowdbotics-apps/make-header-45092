"""
Django settings for make_header_45092 project.
...
ROOT_URLCONF = 'make_header_45092.urls'
...
WSGI_APPLICATION = 'make_header_45092.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "make_header_45092 API",
    "DESCRIPTION": "API documentation for make_header_45092 App",
    "VERSION": "v1",
}
